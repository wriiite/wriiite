  ...
  grunt.initConfig({
    ...
    styles: {
      ...
      "dist/styles.css": {
        ...
        src: "public/app/styles/index.css",

        // The relative path to use for the @imports.
        paths: ["public/app/styles"],
    ...
    copy: {
      release: {
        files: [
          { src: ["public/app/**"], dest: "dist/" },
          { src: "public/vendor/**", dest: "dist/" }
        ]
      }
    },
    ...
    karma: {
      options: {
        ...
        files: [
          ...
          {
            pattern: "public/test/<%= karma.options.frameworks[0] %>/**/*.spec.js",
            included: false
          },
    ...
    coveralls: {
      options: {
        coverage_dir: "public/test/coverage/PhantomJS 1.9.2 (Linux)/"
      }
    }
  });
